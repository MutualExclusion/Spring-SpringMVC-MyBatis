...
public interface BbsProductDao{
	/**
	 ...
	 * @return
	 */
    int updateBbsProduct(@Param("enti") BbsProduct value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyBbsProduct(@Param("enti") BbsProduct value, @Param("assist") Assist assist);
}