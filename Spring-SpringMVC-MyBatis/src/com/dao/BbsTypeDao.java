...
public interface BbsTypeDao{
	 ...
	 * @return
	 */
    int updateBbsType(@Param("enti") BbsType value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyBbsType(@Param("enti") BbsType value, @Param("assist") Assist assist);
}