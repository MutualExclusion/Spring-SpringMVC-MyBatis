...
public interface BbsBrandDao{
	 ...
	 * @return
	 */
    int updateBbsBrand(@Param("enti") BbsBrand value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyBbsBrand(@Param("enti") BbsBrand value, @Param("assist") Assist assist);
}