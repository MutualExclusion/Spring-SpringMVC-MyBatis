...
public interface BbsSkuDao{
	 ...
	 * @return
	 */
    int updateBbsSku(@Param("enti") BbsSku value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyBbsSku(@Param("enti") BbsSku value, @Param("assist") Assist assist);
}