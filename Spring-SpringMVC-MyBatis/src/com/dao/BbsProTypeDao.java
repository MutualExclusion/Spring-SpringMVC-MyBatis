...
public interface BbsProTypeDao{
	/**
	 ...
	 * @return
	 */
    int updateBbsProType(@Param("enti") BbsProType value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyBbsProType(@Param("enti") BbsProType value, @Param("assist") Assist assist);
}