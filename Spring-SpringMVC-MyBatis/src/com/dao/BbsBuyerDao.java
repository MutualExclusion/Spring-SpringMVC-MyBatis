...
public interface BbsBuyerDao{
	 ...
	 * @return
	 */
    int updateBbsBuyer(@Param("enti") BbsBuyer value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyBbsBuyer(@Param("enti") BbsBuyer value, @Param("assist") Assist assist);
}