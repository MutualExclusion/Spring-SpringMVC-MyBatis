...
public interface BbsOrderDao{
	 ...
	 * @return
	 */
    int updateBbsOrder(@Param("enti") BbsOrder value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyBbsOrder(@Param("enti") BbsOrder value, @Param("assist") Assist assist);
}